  ...
  return (
    <>
      ...
      <Container className="self-stretch xl:mt-9">
        <div className="flex  flex-col-reverse xl:flex-row gap-12 xl:h-[805px] justify-between lg:mb-20 items-center relative sm:px-16 xl:pl-0 sm:py-[50px] py-8 xl:py-[100px]">
