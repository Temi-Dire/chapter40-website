  ...
  return (
    <>
      ...
      <div className="m-4 lg:mx-16 text-[#7C7C7C] flex flex-col">
        <div>
          <h1 className="font-playfair text-lg font-bold text-[#242424] lg:text-xl">
            Order Confirmed!
          </h1>
        ...
        <div className="grid grid-cols-3 gap-4">
          ...
          <div className="justify-self-center  self-center text-[#242424]">
            01
          </div>
          <div className="justify-self-end self-center text-[#242424]">
            $30000
          </div>
        </div>
        ...
        <div className="lg:flex lg:justify-between mb-10">
          <div className="font-montserrat">
            <div className="flex justify-between mb-4 md:w-60">
              <p>Subtotal</p>
          ...
          <div>
            <div className="mb-10 lg:mb-5">
              ...
              <p className="font-semibold text-[#242424] font-montserrat">
                Transfer/Card
              </p>
            </div>
        ...
        <button
          className="text-white bg-purple-950 w-full py-3 font-roboto lg:w-60 self-center"
