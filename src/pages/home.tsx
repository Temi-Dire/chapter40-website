  ...
  return (
    <>
      ...
      <section className="max-w-[1440px] mx-auto w-full px-[20px] xl:px-[40px] 2xl:px-[58px] bg-[url('/assets/images/elegance.png')] bg-center bg-cover min-h-[358px] h-full md:h-[420px] lg:h-[500px] 2lg:h-[540px] xl:h-[600px] 2xl:h-[649px] relative max-h-[649px] my-[50px] overflow-hidden">
        <div className="overlay z-10 absolute top-0 left-0 right-0 bottom-0 bg-black bg-opacity-50"></div>
        <div className="absolute z-20 text-white-300 font-montserrat top-1/2 -translate-y-1/2 right-0 2lg:left-1/2 px-[20px] grid gap-[8px] md:gap-[12px] xl:gap-[15px] md:text-[16px] 2xl:text-[18px]">
          ...
          <button
            className="bg-white text-black text-[15px] px-[16px] py-[10px] font-light w-fit mt-[10px] cursor-pointer hover:scale-105 hover:rounded-sm transition-all duration-300 ease-in-out"
