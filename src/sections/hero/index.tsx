...
import starWhite from "/assets/stars.svg";
      ...
      <div className="grid grid-cols-2 max-w-[1440px] mx-auto h-[536.5px] overflow-x-hidden 2sm:h-[600px] 2lg:h-[calc(100vh-68px)] max-h-[1024px]">
        <div className="bg-white absolute top-0 left-0  w-full h-[590px] 2sm:h-[650px] overflow-y-hidden 2lg:h-[100vh] max-h-[1024px]">
          <div className="h-full w-full relative max-w-[1440px] mx-auto">
            <div className="absolute z-50 left-[20px] lg:left-[50px] 2lg:left-[90px] top-[85px] 2lg:top-[140px] bg-[#DD3FC0] bg-opacity-10">
              <Minicard
            ...
            <img
              className="absolute z-40 bottom-0 w-[243.75px] 2sm:w-[280px] h-auto left-2/4 -translate-x-2/4 2lg:w-[310px] 2xl:w-[360px] 3xl:w-[375px]"
              src={heroDress}
              alt=""
            />
            <h1 className="font-playfair text-[64px] 2sm:text-[80px] 2xl:text-[100px] uppercase absolute top-1/2 -translate-y-[70%] 2xl:-translate-y-[85%] z-30 left-1/2 -translate-x-1/2 flex gap-20 2sm:gap-[100px] lg:gap-[20px]">
              ...
              <span className="hidden xl:block relative">
                fashion
                <div className="absolute top-[110px] 2xl:top-[130px] text-[16px] font-montserrat normal-case text-black-500 w-[] 3xl:top-[150px]">
                  <p>
                    is simply dummy text of the printing and typesetting
                    industry. Lorem Ipsum has been the industry's standard dummy
                    text ever since the 1500s, when an unknown printer took a
        ...
        <div className="bg-gradient-to-b from-[#A1419C] to-[#812ABE] absolute top-0 right-0 max-w-[50%] w-full h-[590px] 2sm:h-[650px] 2lg:h-[100vh] max-h-[1024px] overflow-y-hidden">
          ...
          <div className="absolute z-[60] bottom-[130px] xl:bottom-[160px] 2xl:bottom-[180px] lg:left-[65px] 2lg:left-[80px] xl:left-[140px] 2xl:left-[220px] text-white bg-white bg-opacity-20 whitespace-pre-line">
            <Minicard
              desc="Red ankara gown sumami crimison black"
              price={30000}
              id={1}
