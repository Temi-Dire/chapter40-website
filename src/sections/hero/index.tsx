  ...
  return (
    <>
      <section className="grid grid-cols-2 w-full">
        <div className="bg-white pt-[210px] pl-[74.5px] -z-20">
          <Minicard />
          <h1 className="font-playfair mt-9 mb-7 text-8xl">FASHION</h1>
          <p className="text-base font-montserrat text-[#7C7C7C] w-[460px] mb-7">
        ...
        <div className="bg-[#A15DB3] pt-[210px] pr-[74.5px] -z-20">
