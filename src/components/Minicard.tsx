...
const Minicard: React.FC<CardProps> = ({ desc, price, id, }) => {
  ...
  return (
    <div
      key={id}
      className="rounded-sm text-[11px] grid grid-cols-[50px,1fr] 2sm:grid-cols-[70px,1fr] 2lg:grid-cols-[100px,1fr] place-items-start relative p-[10px] font-montserrat max-w-[210px] 2sm:max-w-[250px] md:max-w-[270px] 2lg:max-w-[320px] w-full 2sm:text-[12px] max-h-[100px]"
    >
