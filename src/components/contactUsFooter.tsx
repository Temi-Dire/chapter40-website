const FormFooter = () => {
  return (
    <div className="mt-4 font-poppins">
      <div className="flex justify-between lg:text-sm max-w-full text-xs  flex-wrap   [&>*:not(:last-child)]:mb-5">
        <div className="flex sm:mr-7">
          ...
          <div>
            <p>PHONE</p>
            <p className="text-[#36254B] whitespace-nowrap">Official number</p>
          </div>
        </div>
        ...
        <div className="flex ">
          ...
          <div className="flex flex-col flex-wrap">
            <p>EMAIL</p>
            <p className="text-[#36254B]]">official/site's email</p>
          </div>
        </div>
      </div>
    </div>
